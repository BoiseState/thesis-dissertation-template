...
% Dissertation: default is a two-sided document with mirrored margins and
% alternating page number sides, suitable for binding/printing.
\documentclass[dissertation]{bsu-cs}  % for dissertation
\usepackage[inner=1.5in,outer=1in,letterpaper,twoside]{geometry}

% For a one-sided dissertation document, comment out the two previous lines and
...
% Or, the natbib package allows for \citet and using a .bib file for reference handling.
% \usepackage[sort&compress,numbers,square]{natbib}
% \bibliographystyle{plainnat}
% \usepackage[nottoc,notbib]{tocbibind} % adds References/Bibliography to table of contents
...
%% Make table and figure captions bold; note this might mess up 
% longtable tables (if so, try \clearpage right before a longtable)
\usepackage{caption}
\captionsetup{
    labelfont=bf,
    textfont=bf
...
% Additional packages for table and figure formatting.
% \usepackage{makecell}
% \usepackage{multirow}
% \usepackage{enumerate}
% \usepackage{booktabs}
% \usepackage{longtable}
% \usepackage{placeins} % for \FloatBarrier, useful for placing tables and figures within text sections
...
% Example: for colored edits starting with 'ME:' and 'ADVISOR:'
\newcommand{\myedit}[1]{\textcolor{red}{ME: #1}} % now, use '\myedit{...}'
\newcommand{\advisoredit}[1]{\textcolor{purple}{ADVISOR: #1}}
...
\bibliographystyle{plain} % or plainnat if using natbib

% If using natbib package
% \bibliography{NAME_OF_BIB_FILE}

% Another way of constructing the bibliography is to list the entries explicitly
